...
// ============ COMMENTED OUT: cbri-outside Order Success page (disabled per order-flow simplification) ============
...
function SuccessContent() {
  ...
  // ============ ORIGINAL cbri-outside ORDER SUCCESS PAGE BELOW (COMMENTED OUT) ============
  /*
  ...
  */
  // ============ END ORIGINAL cbri-outside ORDER SUCCESS PAGE ============
}
